 ...
 * -----------------------
 */
// Если параметр "lelah" отсутствует в GET и POST, выполнить редирект на главную страницу
if (!isset($_GET['lelah']) && !isset($_POST['lelah'])) {
    header("Location: /"); // Замените '/' на нужный URL главной страницы, если необходимо
    exit;
}
